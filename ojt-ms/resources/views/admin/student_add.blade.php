                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2 mb-4">
                        <div class="form-outline">
                          ...
                          <input type="text" id="middle_initial" name="middle_initial" class="form-control form-control-md @error('middle_initial') is-invalid @enderror" maxlength="1" required/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="form-outline">                    
                              ...
                              <input type="text" id="contact" name="contact" class="form-control form-control-md @error('contact') is-invalid @enderror" maxlength="11" required/>
                              @error('contact')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
