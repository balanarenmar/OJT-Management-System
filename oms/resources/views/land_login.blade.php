        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 20px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form action="/requestLogin" method="POST" id="login">
              @csrf
                <input type="hidden" name="account_id" value="{{ $accountId }}" class="form-control form-control-md @error('accountId') is-invalid @enderror">
                {{-- @error('accountId')
              ...
              <div class="row w-100 " >
                <div class="col-lg-6 mb-4 pb-2 pl-0 mx-auto ">
                  ...
                  <div class="form-outline">                    
                    ...
                    <input type="password" id="password" name="password" class="form-control form-control-md @error('password') is-invalid @enderror" maxlength="32"/>
                    @error('password')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
